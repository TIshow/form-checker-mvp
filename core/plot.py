...
def save_com_height_graph(metrics: dict, com: np.ndarray,
                          up_ax: int, up_sign: float, path: str,
                          phases: tuple[str, str] = ("loading", "contact"),
                          title: str = "center of mass height") -> None:
    """重心の高さ vs 時間。指定した2つの局面に注釈を付ける。
